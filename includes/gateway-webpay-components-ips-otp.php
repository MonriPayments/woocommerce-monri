...
class Monri_WC_Gateway_Webpay_Components_Ips_Otp extends Monri_WC_Gateway_Webpay_Components_Abstract {
	 ...
	 * @var string
	 */
	public $id = 'monri_components_ips_otp';

	/**
	 * Components Ips Rs constructor.
	 *
	 * @return void
	 */
	public function __construct() {
		...
		$this->title       = __( 'Monri Ips Otp', 'monri' );
		$this->description = __( 'Pay with Monri Ips Otp', 'monri' );
