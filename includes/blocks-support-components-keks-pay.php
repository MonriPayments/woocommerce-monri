...
final class Monri_WC_Components_Keks_Pay_Blocks_Support extends AbstractPaymentMethodType {
	 ...
	 *
	 * @var Monri_WC_Gateway_Webpay_Components_Keks_Pay
	 */
	private $gateway;
	...
	public function get_payment_method_script_handles() {
		$script_path       = '/assets/js/blocks/keks-pay.js';
		$script_asset_path = MONRI_WC_PLUGIN_PATH . 'assets/js/blocks/keks-pay.asset.php';
