...
class Monri_WC_Gateway_Webpay_Components_Flik_Pay extends Monri_WC_Gateway_Webpay_Components_Abstract {
	 ...
	 * @var string
	 */
	public $id = 'monri_components_flik_pay';

	/**
	 * Components Flik Pay constructor.
	 *
	 * @return void
	 */
	public function __construct() {
		...
		$this->title       = __( 'Monri Flik Pay', 'monri' );
		$this->description = __( 'Pay with Monri Flik Pay', 'monri' );
