...
class Monri_WC_Gateway_Webpay_Components_Air_Cash extends Monri_WC_Gateway_Webpay_Components_Abstract {
	 ...
	 * @var string
	 */
	public $id = 'monri_components_air_cash';

	/**
	 * Components Air Cash constructor.
	 *
	 * @return void
	 */
	public function __construct() {
		...
		$this->title       = __( 'Monri Air Cash', 'monri' );
		$this->description = __( 'Pay with Monri Air Cash', 'monri' );
