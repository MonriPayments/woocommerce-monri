...
class Monri_WC_Gateway_Webpay_Components_Apple_Pay extends Monri_WC_Gateway_Webpay_Components_Abstract {
	 ...
	 * @var string
	 */
	public $id = 'monri_components_apple_pay';

	/**
	 * Components Apple Pay constructor.
	 *
	 * @return void
	 */
	public function __construct() {
		...
		$this->title       = __( 'Monri Apple Pay', 'monri' );
		$this->description = __( 'Pay with Monri Apple Pay', 'monri' );
