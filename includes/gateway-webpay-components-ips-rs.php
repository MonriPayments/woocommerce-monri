...
class Monri_WC_Gateway_Webpay_Components_Ips_Rs extends Monri_WC_Gateway_Webpay_Components_Abstract {
	 ...
	 * @var string
	 */
	public $id = 'monri_components_ips_rs';
	...
	public function __construct() {
		...
		$this->title       = __( 'Monri Ips Rs', 'monri' );
		$this->description = __( 'Pay with Monri Ips Rs', 'monri' );
